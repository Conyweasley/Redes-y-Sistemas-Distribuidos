...
void Packet::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimArrayPacking(b,this->array,8);
    doParsimPacking(b,this->isHello_);
    doParsimPacking(b,this->way);
}
...
void Packet::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimArrayUnpacking(b,this->array,8);
    doParsimUnpacking(b,this->isHello_);
    doParsimUnpacking(b,this->way);
}
...
size_t Packet::getArrayArraySize() const
{
    return 8;
}

int Packet::getArray(size_t k) const
{
    if (k >= 8) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)8, (unsigned long)k);
    return this->array[k];
}

void Packet::setArray(size_t k, int array)
{
    if (k >= 8) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)8, (unsigned long)k);
    this->array[k] = array;
}

bool Packet::isHello() const
{
    return this->isHello_;
}

void Packet::setIsHello(bool isHello)
{
    this->isHello_ = isHello;
}

int Packet::getWay() const
{
    return this->way;
}

void Packet::setWay(int way)
{
    this->way = way;
}
...
unsigned int PacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISARRAY | FD_ISEDITABLE,    // FIELD_array
        FD_ISEDITABLE,    // FIELD_isHello
        FD_ISEDITABLE,    // FIELD_way
    };
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "array") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "isHello") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "way") == 0) return baseIndex + 5;
...
std::string PacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_isHello: return bool2string(pp->isHello());
        case FIELD_way: return long2string(pp->getWay());
        default: return "";
    }
}
...
void PacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_isHello: pp->setIsHello(string2bool(value)); break;
        case FIELD_way: pp->setWay(string2long(value)); break;
...
omnetpp::cValue PacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_isHello: return pp->isHello();
        case FIELD_way: return pp->getWay();
...
void PacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_isHello: pp->setIsHello(value.boolValue()); break;
        case FIELD_way: pp->setWay(omnetpp::checked_int_cast<int>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'Packet'", field);
    }
}
